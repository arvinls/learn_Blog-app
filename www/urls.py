...
def user_interceptor(next):
	logging.info('try to build user from session cookie...')
	user = None
...
def authenticate():
	...
	cookie = make_signed_cookies(user.id, user.password, max_age)
...
def register_user():
	...
	user.insert()
	#make session cookie:
	cookie = make_signed_cookies(user.id, user.password, None)
